...
const Header = (props: {
  ...
  return (
    <>
              ...
              <div className="menu p-10 w-80 min-h-full bg-base-200">
                ...
                <div className='pt-10'>
                  <label htmlFor="my-drawer" aria-label="close sidebar" className='h-screen'>
                    ...
                    <CategoryData categoryData={props.categoryData} setCategory={props.setCategory} />
                  </label>
                </div>
              </div>
            </div>
      ...
      <div className={
        collapse === false ?
          "w-full -z-50 flex justify-center border-b-2 -translate-y-36 transition-all " :
          "w-full -z-50 flex justify-center pt-4 pb-6 transition-all"
      }>
        <div className={
          collapse === false ?
            'sm:w-96 flex items-center justify-between' :
            'border-b-2 sm:w-96 w-64 flex items-center justify-between'
        }>
          <input
            type="text"
            className="mb-3 text-2xl w-56 border-none focus:outline-none"
            placeholder={
              collapse === false ?
                '' :
                'Search'
