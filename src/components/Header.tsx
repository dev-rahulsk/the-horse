  ...
  return (
    <>
      <div className="navbar bg-base-100 z-10 relative">
            ...
            <div className="drawer-content">
              <label htmlFor="my-drawer" className="drawer-button">
                <div role="button" className="btn btn-ghost btn-circle">
                  <svg xmlns="http://www.w3.org/2000/svg" className="sm:h-6 sm:w-6 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
                </div>
              </label>
            </div>
            <div className="drawer-side z-10">
              ...
              <div className="menu p-10 w-80 min-h-full bg-base-200">
                ...
                <label htmlFor="my-drawer" aria-label="close sidebar">
                  <svg xmlns="http://www.w3.org/2000/svg" className="sm:h-6 sm:w-6 h-5 w-5 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" /></svg>
                </label>
                <div className='pt-10'>
        ...
        <div className="navbar-center bg-base-100">
          <a href='/' className="cursor-pointer">
            <svg strokeWidth="187" height="20" className='sm:h-5 h-4' viewBox="0 0 187 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="navbar-end bg-base-100">
          <button
            ...
            className="btn btn-ghost btn-circle justify-end sm:justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="sm:h-6 sm:w-6 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
          </button>
          <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
            <div className="indicator">
              <svg xmlns="http://www.w3.org/2000/svg" className="sm:h-6 sm:w-6 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
      ...
      <div className={
        ...
        <div className={
          collapse === false ?
            'sm:w-96 w-64 flex items-center justify-between relative' :
            'sm:w-96 w-64 flex items-center justify-between border-b-2 relative'
        }>
          <input
            type="text"
            list='search'
