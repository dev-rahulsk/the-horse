...
const Header = (props: {
  ...
  return (
    <>
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-center bg-base-100">
          <a href='/' className="font-semibold text-2xl cursor-pointer">
            <svg strokeWidth="187" height="20" viewBox="0 0 187 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={
        collapse === false ?
          "w-full -z-50 flex justify-center border-b-2 .+transition-all -translate-y-36" :
